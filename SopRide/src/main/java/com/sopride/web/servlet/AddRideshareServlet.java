...
public class AddRideshareServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			// r�cup�ration des diff�rentes classes pour manipuler les tables de la base de donn�es
			...
			// cr�ation/v�rification l'adresse de d�part (maison)		 
			...
			// d�termination de l'adresse d'arriv�e (lieu de travail)
			...
			// v�rification heure d�part le matin et heure de d�part le soir
